...
if (formSubmitBtn && resendMessage) {
    formSubmitBtn.addEventListener('click', (e) => {
        ...
        if (!rechaptcha) {
            document.getElementById('recaptcha').style.display = 'block';
            document.getElementById('recaptcha-error').innerHTML = `<small class="error-text"><i class="fa fa-exclamation-triangle"></i> Veuillez d'abord valider le captcha !</small>`;
            resendMessage = true;
        } else {
